...
const Sidebar = () => {
  return (
    <div className="w-[300px] bg-gray-50 mt-2 rounded-t-xl border-r p-4 flex flex-col justify-between overflow-y-auto">
      ...
      <div>
        ...
        <ul className="text-sm space-y-2">
          ...
          <li className="bg-[#E8F0FF] text-[#3A7EFF] px-3 py-2 flex items-center justify-between rounded-lg cursor-pointer font-medium">
            <span className="flex items-center gap-2"><IoChatboxEllipsesOutline className="text-black" /> Create Chatbot
            GPT...</span>
        ...
        <ul className="text-sm space-y-2">
          <li className="hover:bg-gray-100 px-3 py-2 flex items-center gap-2 rounded-lg cursor-pointer">
          <IoChatboxEllipsesOutline className="text-black"/> Crypto Lending App Name
          </li>
          <li className="hover:bg-gray-100 px-3 py-2 flex items-center gap-2 rounded-lg cursor-pointer">
          <IoChatboxEllipsesOutline className="text-black"/> Operator Grammar Types
          </li>
        </ul>
      </div>
